...
class Monster(object):
    ...
    def Pos(self):
        ...
        if o != 0:
            x = o + self._tab.Pos
            from FlatBuffer.Sample.Vec3 import Vec3
            obj = Vec3()
    ...
    def Weapons(self, j):
        ...
        if o != 0:
            ...
            from FlatBuffer.Sample.Weapon import Weapon
            obj = Weapon()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
...
def MonsterAddInventory(builder, inventory): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(inventory), 0)
...
def MonsterAddColor(builder, color): builder.PrependInt8Slot(5, color, 3)
def AddColor(builder, color):
    return MonsterAddColor(builder, color)
def MonsterAddWeapons(builder, weapons): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(weapons), 0)
def AddWeapons(builder, weapons):
    return MonsterAddWeapons(builder, weapons)
...
def MonsterAddEquippedType(builder, equippedType): builder.PrependUint8Slot(7, equippedType, 0)
def AddEquippedType(builder, equippedType):
    return MonsterAddEquippedType(builder, equippedType)
def MonsterAddEquipped(builder, equipped): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(equipped), 0)
def AddEquipped(builder, equipped):
    return MonsterAddEquipped(builder, equipped)
def MonsterAddPath(builder, path): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(path), 0)
def AddPath(builder, path):
    return MonsterAddPath(builder, path)
